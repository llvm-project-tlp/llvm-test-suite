...
compile;20181025-1.f;;-Ofast -mavx2;
...
compile;bind_c_array_params_2.f90;;-std=f2008ts -fdump-tree-original -mno-explicit-relocs -mno-relax-pic-calls;
...
compile;coarray_alloc_comp_4.f08;;-fcoarray=lib -fdump-tree-original -latomic;
...
compile;common_16.f90;;-pedantic -mdalign;
...
compile;common_5.f;;-pedantic-errors -mdalign;
...
compile;integer_exponentiation_3.F90;;-ffloat-store;
...
compile;nint_p7.f90;;-O2 -mdejagnu-cpu=power7 -ffast-math;
...
compile;pr101121.f;;-Ofast -std=legacy -march=haswell;
compile;pr101158.f90;;-O1 -ftree-slp-vectorize -fwrapv -march=armv8-a+sve;
compile;pr101264.f90;;-Ofast;
compile;pr101267.f90;;-Ofast -march=znver2;
...
compile;pr102860.f90;;-O2 -mdejagnu-cpu=power10;
...
compile;pr103628.f90;xfail;-O2 -mabi=ibmlongdouble;
...
compile;pr108193.f90;;-O2 -fsplit-loops -ftree-parallelize-loops=2 -fno-tree-dominator-opts;
...
compile;PR24188.f;;-O2 -O2 -mcmodel=medium;
...
compile;pr28158.f90;;-O -msse -mfpmath=sse;
compile;pr28971.f90;;;
compile;pr29067.f;;;
compile;pr29713.f90;;-std=legacy;
compile;pr30391-1.f90;;-O1;
compile;pr30667.f;;-O2 -msse -ftree-vectorize -std=legacy;
...
compile;pr36680.f90;;-O1 -fschedule-insns;
...
compile;pr42246-2.f;;-O2 -fselective-scheduling -fsel-sched-pipelining -fsel-sched-pipelining-outer-loops;
compile;pr42294.f;;-O2 -fselective-scheduling2 -fsel-sched-pipelining -funroll-all-loops;
compile;pr42651.f90;xfail;;
compile;pr43229.f90;;-g -O3 -ffast-math -g -O3 -ffast-math -msse3;
...
compile;pr44691.f;;-O2 -fselective-scheduling2;
...
compile;pr46519-1.f;;-O3 -mavx -mvzeroupper -fno-tree-slp-vectorize -mtune=generic -dp;
compile;pr46519-2.f90;;-O3 -mavx -mvzeroupper -mtune=generic -dp;
compile;pr46755.f;;-O;
compile;pr46884.f;;;
...
compile;pr58968.f;;-mdejagnu-cpu=power7 -O3 -w -ffast-math -funroll-loops;
...
compile;pr68379-2.f;;-Ofast -mavx;
compile;pr68544.f90;xfail;;
compile;pr68592.f;;-Ofast -fprofile-generate -mavx;
...
compile;pr81175.f;;-Ofast -fwrapv -std=legacy -march=broadwell;
...
compile;pr84565.f90;;-mlow-precision-sqrt -funsafe-math-optimizations;
...
compile;pr88148.f90;;-O -fno-tree-fre -fno-tree-sra -ftree-loop-vectorize -mavx2;
...
compile;pr88934.f90;;-O -ftree-vectorize -mvsx;
...
compile;pr92161.f;;-O1 -ftree-loop-vectorize -fno-signed-zeros -fno-trapping-math -mvsx;
compile;pr92277.f90;;;
compile;pr92537.f90;;-O2 -ftree-vectorize -fno-inline -march=skylake;
compile;pr92781.f90;;;
...
compile;pr94708.f90;;-O2 -funsafe-math-optimizations -fdump-rtl-combine;
compile;pr95053.f;;;
...
compile;pr98974.F90;;-Ofast -mcpu=neoverse-v1;
...
compile;simd-builtins-1.f90;;-nostdinc -Ofast -fpre-include=simd-builtins-1.h -fdump-tree-optimized -msse2 -mno-avx;
compile;simd-builtins-2.f90;;-nostdinc -Ofast -fdump-tree-optimized -msse2;
...
compile;simd-builtins-6.f90;;-nostdinc -Ofast -fdump-tree-optimized -msse2 -mno-avx;
compile;simd-builtins-7.f90;;-msse2 -mno-avx -nostdinc -Ofast -fpre-include=simd-builtins-7.h -fdump-tree-optimized;
compile;simd-builtins-8.f90;;-nostdinc -Ofast -fpre-include=simd-builtins-8.h -fdump-tree-optimized;
...
link;coarray_43.f90;;-fcoarray=lib -lcaf_single -latomic;
...
run;chmod_2.f90;;-std=gnu;
run;chmod_3.f90;;-std=gnu -fdefault-integer-8;
run;class_1.f03;;;
run;class_18.f03;;;
...
run;coarray_40.f90;;-fcoarray=lib -lcaf_single -latomic;
run;coarray_41.f90;;-fcoarray=lib -lcaf_single -latomic;
run;coarray_42.f90;;-fdump-tree-original -fcoarray=lib -lcaf_single -latomic;
run;coarray_alloc_comp_1.f08;;-fcoarray=lib -lcaf_single -latomic;
run;coarray_alloc_comp_2.f08;;-fcoarray=lib -lcaf_single -latomic;
run;coarray_alloc_comp_3.f08;;-fcoarray=lib -lcaf_single -latomic;
run;coarray_alloc_comp_6.f08;;-fcoarray=lib -lcaf_single -latomic;
run;coarray_alloc_comp_7.f08;;-fcoarray=lib -lcaf_single -latomic;
run;coarray_alloc_comp_8.f08;;-fcoarray=lib -lcaf_single -latomic;
run;coarray_allocate_10.f08;;-fcoarray=lib -lcaf_single -latomic;
...
run;coarray_allocate_5.f08;;-fcoarray=lib -lcaf_single -fdump-tree-original -latomic;
run;coarray_allocate_6.f08;;-fcoarray=single -fdump-tree-original;
run;coarray_allocate_7.f08;;-fcoarray=lib -lcaf_single -fdump-tree-original -latomic;
run;coarray_allocate_8.f08;;-fcoarray=lib -lcaf_single -fdump-tree-original -latomic;
run;coarray_allocate_9.f08;;-fcoarray=lib -lcaf_single -latomic;
run;coarray_collectives_17.f90;;-fcoarray=single;
run;coarray_data_1.f90;;-fcoarray=lib -lcaf_single -latomic;
run;coarray_failed_images_1.f08;;-fdump-tree-original -fcoarray=lib -lcaf_single -latomic;
run;coarray_image_status_1.f08;;-fcoarray=lib -lcaf_single -fdump-tree-original -latomic;
run;coarray_lib_alloc_4.f90;;-fcoarray=lib -lcaf_single -fdump-tree-original -latomic;
run;coarray_lib_comm_1.f90;;-fdump-tree-original -fcoarray=lib -lcaf_single -latomic;
run;coarray_poly_9.f90;;-fcoarray=single;
run;coarray_ptr_comp_1.f08;;-fcoarray=lib -lcaf_single -latomic;
run;coarray_ptr_comp_2.f08;;-fcoarray=lib -lcaf_single -latomic;
run;coarray_send_by_ref_1.f08;;-fcoarray=lib -lcaf_single -latomic;
run;coarray_stat_2.f90;;-fcoarray=lib -lcaf_single -latomic;
run;coarray_stopped_images_1.f08;;-fdump-tree-original -fcoarray=lib -lcaf_single -latomic;
run;coindexed_1.f90;;-fcoarray=lib -lcaf_single -latomic;
...
run;common_align_2.f90;;-pedantic-errors -mdalign;
...
run;dec_io_2.f90;;-fdec;
run;dec_io_2a.f90;;-fdec;
...
run;enum_1.f90;;;
run;enum_10.f90 enum_10.c;;-fshort-enums -w -fshort-enums -w -Wl,--no-enum-size-warning;
run;enum_9.f90;;-fshort-enums -fshort-enums -Wl,--no-enum-size-warning;
run;eof_1.f90;;;
run;eof_2.f90;;;
run;eof_3.f90;;;
run;eof_4.f90;;;
...
run;ISO_Fortran_binding_1.f90 ISO_Fortran_binding_1.c;;;
run;ISO_Fortran_binding_10.f90 ISO_Fortran_binding_10.c;;;
run;ISO_Fortran_binding_11.f90 ISO_Fortran_binding_11.c;;;
run;ISO_Fortran_binding_12.f90 ISO_Fortran_binding_12.c;;;
run;ISO_Fortran_binding_13.f90 ISO_Fortran_binding_13.c;;;
run;ISO_Fortran_binding_14.f90;;;
run;ISO_Fortran_binding_15.f90 ISO_Fortran_binding_15.c;;;
...
run;ISO_Fortran_binding_7.f90 ISO_Fortran_binding_7.c;;;
run;ISO_Fortran_binding_8.f90 ISO_Fortran_binding_8.c;;;
run;ISO_Fortran_binding_9.f90 ISO_Fortran_binding_9.c;;;
...
run;pr32635.f;;;
run;pr33794.f90;;-O2 -ffast-math -mfpmath=387 -O2 -ffast-math;
run;pr35662.f90;;-O1;
run;pr35944-1.f90;;;
run;pr35944-2.f90;;;
run;pr35983.f90;;;
...
run;pr47008.f03;;-Os -fno-asynchronous-unwind-tables -fschedule-insns -fsched-pressure -fno-inline;
run;pr47614.f;;-O3 -funroll-loops -ffast-math -mdejagnu-cpu=power4 -O3 -funroll-loops -ffast-math;
run;pr47757-1.f90;;;
run;pr47757-2.f90;;;
run;pr47757-3.f90;;;
run;pr47878.f90;;;
...
run;pr64530.f90;;;
run;pr65429.f90;;;
run;pr65450.f90;;-mtune=amdfam10;
run;pr65504.f90;;;
...
run;pr67885.f90;;;
run;pr68053.f90;;;
run;pr68078.f90 set_vm_limit.c;;;
run;pr68566.f90;;;
run;pr69455_1.f90;;;
run;pr69455_2.f90;;;
run;pr69514_1.f90;;;
...
run;promotion.f90;;-fdefault-integer-8 -fdefault-real-8 -fdefault-double-8;
...
run;real4-10-real8-10.f90;;-w -freal-4-real-10 -freal-8-real-10;
run;real4-10-real8-16.f90;;-w -freal-4-real-10 -freal-8-real-16;
run;real4-10-real8-4.f90;;-w -freal-4-real-10 -freal-8-real-4;
run;real4-10.f90;;-w -freal-4-real-10;
run;real4-16-real8-10.f90;;-w -freal-4-real-16 -freal-8-real-10;
...
run;real4-8-real8-10.f90;;-w -freal-4-real-8 -freal-8-real-10;
...
run;real8-10.f90;;-w -freal-8-real-10;
