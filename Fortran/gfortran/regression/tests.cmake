...
compile;20181025-1.f;;-Ofast -mavx2;x86_64-.+-.+ i.86-.+-.+;
...
compile;bind_c_array_params_2.f90;;-std=f2008ts -fdump-tree-original -mno-explicit-relocs -mno-relax-pic-calls;alpha.+-.+-.+ mips.+-.+-.+;
...
compile;common_16.f90;;-pedantic -mdalign;sh.+-.+-.+;
...
compile;common_5.f;;-pedantic-errors -mdalign;sh.+-.+-.+;
...
compile;pr101121.f;;-Ofast -std=legacy -march=haswell;x86_64-.+-.+ i.86-.+-.+;
compile;pr101158.f90;;-O1 -ftree-slp-vectorize -fwrapv -march=armv8-a+sve;aarch64-.+-.+;
compile;pr101264.f90;;-Ofast;;
compile;pr101267.f90;;-Ofast -march=znver2;x86_64-.+-.+ i.86-.+-.+;
...
compile;pr43229.f90;;-g -O3 -ffast-math -g -O3 -ffast-math -msse3;i.86-.+-.+ x86_64-.+-.+;
...
compile;pr54889.f90;;-O3 -mavx;i.86-.+-.+ x86_64-.+-.+;
compile;pr54967.f90;;;;
...
compile;pr68379-2.f;;-Ofast -mavx;x86_64-.+-.+ i.86-.+-.+;
compile;pr68544.f90;xfail;;;
compile;pr68592.f;;-Ofast -fprofile-generate -mavx;x86_64-.+-.+ i.86-.+-.+;
...
compile;pr81175.f;;-Ofast -fwrapv -std=legacy -march=broadwell;x86_64-.+-.+ i.86-.+-.+;
...
compile;pr88148.f90;;-O -fno-tree-fre -fno-tree-sra -ftree-loop-vectorize -mavx2;x86_64-.+-.+ i.86-.+-.+;
...
compile;pr88934.f90;;-O -ftree-vectorize -mvsx;powerpc.+-.+-.+;
...
compile;pr92161.f;;-O1 -ftree-loop-vectorize -fno-signed-zeros -fno-trapping-math -mvsx;powerpc.+-.+-.+;
compile;pr92277.f90;;;;
compile;pr92537.f90;;-O2 -ftree-vectorize -fno-inline -march=skylake;x86_64-.+-.+ i.86-.+-.+;
compile;pr92781.f90;;;;
...
compile;pr98974.F90;;-Ofast -mcpu=neoverse-v1;aarch64.+-.+-.+;
...
compile;simd-builtins-1.f90;;-nostdinc -Ofast -fpre-include=simd-builtins-1.h -fdump-tree-optimized -msse2 -mno-avx;i.86-.+-linux.+ x86_64-.+-linux.+ aarch64.+-.+-linux.+ i.86-.+-linux.+ x86_64-.+-linux.+;
compile;simd-builtins-2.f90;;-nostdinc -Ofast -fdump-tree-optimized -msse2;i.86-.+-linux.+ x86_64-.+-linux.+ aarch64.+-.+-linux.+ i.86-.+-linux.+ x86_64-.+-linux.+;
...
compile;simd-builtins-6.f90;;-nostdinc -Ofast -fdump-tree-optimized -msse2 -mno-avx;i.86-.+-linux.+ x86_64-.+-linux.+ aarch64.+-.+-linux.+ i.86-.+-linux.+ x86_64-.+-linux.+;
...
run;common_align_2.f90;;-pedantic-errors -mdalign;sh.+-.+-.+;
...
run;pr47008.f03;;-Os -fno-asynchronous-unwind-tables -fschedule-insns -fsched-pressure -fno-inline;i.86-.+-.+ x86_64-.+-.+;
run;pr47614.f;;-O3 -funroll-loops -ffast-math -mdejagnu-cpu=power4 -O3 -funroll-loops -ffast-math;powerpc.+-.+-.+ powerpc64le.+-.+-linux.+;
run;pr47757-1.f90;;;;
run;pr47757-2.f90;;;;
run;pr47757-3.f90;;;;
run;pr47878.f90;;;;
...
run;pr64530.f90;;;;
run;pr65429.f90;;;;
run;pr65450.f90;;-mtune=amdfam10;x86_64-.+-.+ i.86-.+-.+;
run;pr65504.f90;;;;
